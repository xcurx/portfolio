  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-2xl shadow-2xl p-10 md:p-16 rounded-3xl flex flex-col items-center text-center relative z-10 hover:border-violet-500/30 transition-colors duration-500"
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-12">
          <a
            href="mailto:suj5al78@gmail.com"
            className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-white/10 bg-white/5 hover:bg-violet-500/10 hover:border-violet-500/50 transition-all group"
          >
          ...
          <a
            href="https://linkedin.com/in/sujal-kachhawah-058564291"
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-white/10 bg-white/5 hover:bg-violet-500/10 hover:border-violet-500/50 transition-all group"
          >
